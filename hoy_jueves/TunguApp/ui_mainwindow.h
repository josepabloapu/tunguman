...
**
** Created: Wed Dec 11 22:37:52 2013
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        dropdown_team->setGeometry(QRect(100, 390, 161, 27));
        ...
        input_name->setGeometry(QRect(102, 310, 161, 27));
        input_number = new QLineEdit(centralWidget);
        input_number->setObjectName(QString::fromUtf8("input_number"));
        input_number->setGeometry(QRect(100, 350, 161, 27));
        ...
        QObject::connect(button_save, SIGNAL(clicked()), MainWindow, SLOT(on_button_save_clicked()));
