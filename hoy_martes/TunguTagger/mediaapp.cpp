...
void MediaApp::createUI(QBoxLayout *appLayout)
{
    ...
    m_takePicture = initButton (QStyle::SP_ArrowUp, tr("Take Picture"),
                                    this, SLOT(takePictureButtonClicked()), btnLayout);
...
void MediaApp::takePictureButtonClicked() {
    MainWindow *mainWindow;
    mainWindow = new MainWindow();
    mainWindow->open(m_player->state());
    mainWindow->show();
}
